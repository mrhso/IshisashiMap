...
const gcj_wgs = (gcj, checkChina = true) => checkChina && !isInGoogle(gcj.lat, gcj.lon) ? console.warn(`Non-Chinese coords found, returning as-is: (${wgs.lat}, ${wgs.lon})`), gcj : prcoords.gcj_wgs(gcj, false);
